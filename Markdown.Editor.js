...
(function () {
    ...
    Markdown.Editor = function (markdownConverter, idPostfix, help) {
        ...
        this.run = function () {
            ...
            this.panels = new PanelCollection(idPostfix);
            var commandManager = new CommandManager(hooks);
            var previewManager = new PreviewManager(markdownConverter, this.panels, function () { hooks.onPreviewRefresh(); });
            ...
            uiManager = new UIManager(idPostfix, this.panels, undoManager, previewManager, commandManager, help);
            uiManager.setUndoRedoButtonStates();
